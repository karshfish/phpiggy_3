    ...
    <nav class="flex items-center justify-between border-t border-gray-200 px-4 sm:px-0 mt-6">
        ...
        <div class="-mt-px flex w-0 flex-1">
            <?php if ($currentPage > 1) : ?>
                <a href="/?<?php echo htmlspecialchars($previousPageLink); ?>"
        ...
        <div class="flex justify-center items-center h-screen">
            <form action="/" method="get" class="flex flex-col justify-center items-center">
                <label for="length" class="text-sm font-medium text-gray-700">Length:</label>
                <select id="length" name="l" class="ml-2 border-gray-300 text-sm rounded-md mt-2"
                ...
                <p id="current-length" class="mt-4 text-sm font-medium text-gray-700"></p>
            </form>
        </div>
        ...
        <script>
            ...
            const currentLength = getQueryParam('l');
            if (currentLength) {
                document.getElementById('current-length').textContent = `Current Length: ${currentLength}`;
                document.getElementById('length').value = currentLength; // Set the select box value
            }
        </script>
        ...
        <div class="-mt-px flex w-0 flex-1 justify-end">
            <?php if ($currentPage < $lastPage) : ?>
                <a href="/? <?php echo e($nextPageLink); ?> "
